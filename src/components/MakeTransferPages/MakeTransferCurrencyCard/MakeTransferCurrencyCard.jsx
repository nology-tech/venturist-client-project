  ...
  return (
    <div className="transfer-page__currency__card">
      <div className="transfer-page__currency__card--left">
        <CurrencyFlag currency={currency.currencyCode} width={40} onClick={handleChangingCurrency} className="transfer-page__currency__card__flag" data-testid={"currency-flag"}/>
      ...
      <div className="transfer-page__currency__card__overlay" onClick={handleChangingCurrency} id={`transfer-page__currency__${currency.currencyCode}`} data-testid="overlay"></div>
    </div>
  )
}
